...
### 2.2 Our Educational Subdomains {#section2.2}

#### `blog.giantswarm.io`

We like to keep our audience up-to-date on the latest findings using Kubernetes. The Blog subdomain on giantswarm.io, blog.giantswarm.io is updated monthly to inform our users of Kubernetes technology conclusions.

#### docs.giantswarm.io

Documentation posted on the subdomain on giantswarm.io, docs.giantswarm.io is designed to help the user navigate through Kubernetes architecture using our best practices. The docs are updated as new content is written.

#### info.giantswarm.io

Guides and eBooks are an important part of our website, giantswarm.io to inform our users of extensive research and conclusions using the Kubernetes platform. The guides on the subdomain info.giantswarm.io are updated quarterly. 

#### Recipients

Once you have agreed to Giant Swarm’s cookie policy banner on any page, 3rd party cookies will be enabled for the domain and subdomains. These 3rd party web properties are:
...
The processing is based on Art. 6 (1) (f) GDPR. It serves the legitimate interests of the users to access knowledge on Kubernetes best practices. It also serves our legitimate interests to develop our business and promote client relationships.
...
### 2.4 Social Plug-Ins {#section2.4}
...
### 2.5 We use Cookies and Similar Technology {#section2.5}

Cookies allow the website to distinguish you from other users of the site. This helps the originators to optimize websites and also allows certain parts of websites to function correctly. Find out more about cookies and the data processing in this context on [www.allaboutcookies.org](http://www.allaboutcookies.org/).

By using the giantswarm.io website you have the opportunity to agree or decline our use of cookies based on the banner placed on every page. Cookies are set ourselves as well as we use 3rd party plug-ins, which set cookies. The difference in how that data is used and stored is listed below.

### 2.5.1 We use Strictly Necessary Cookies {#section2.5.1}

#### Description and purposes of the processing

We use cookies necessary for users to visit and display our website.
...
Strictly necessary cookie data is processed by Giant Swarm.
Transfer of personal data to third countries or international organizations
Strictly necessary cookie data will not be processed to third countries or international organizations.
...
### 2.5.2 We use Web Analytic Cookies {#section2.5.2}
...
Usage data may be processed by our cookie suppliers on servers in the United States of America. An adequate level of data protection is ensured, as Google LLC HubSpot are certified under the so-called EU-US Privacy Shield.

#### Possible consequences of failure to provide personal data

None.

You may prevent processing of personal data by activating the “do-not-track”-option of your browser<!--or setting an “opt-out”-Cookie on our website by clicking here-->.
...
You have the right to withdraw your consent to us storing these cookies on your device and accessing them from time to time by activating the “do-not-track”-option of your browser<!-- or setting an “opt-out”-cookie on our website by clicking here-->.

### 2.5.3 Third Party Cookies {#section2.5.3}
...
- ShareThis: https://www.sharethis.com/publisher-terms-of-use/
- Gravatar: https://automattic.com/cookies/

## 3. Promoting Our Services {#section3}

### 3.1 General {#section3.1}

#### Controller

Data processing activities in the context of global business development initiatives are generally controlled by Giant Swarm.

Data processing activities in the context of local business development initiatives are ordinarily controlled by the respective Giant Swarm entity.

If different Giant Swarm entities exceptionally act as joint controllers, Giant Swarm is designated as a single point of contact for data subjects under the GDPR.
...
In the conduct of our business, we share certain business development data within Giant Swarm.
...
As a global Enterprise Computing Service, we also share business development data within Giant Swarm. We do not transfer personal data to third countries or international organizations.
...
### 3.2 Newsletters and Updates {#section3.2}

#### Controller

Generally, data processing activities in the context of newsletters and update services (e.g., RSS newsfeed, social media news feeds) are controlled by Giant Swarm.

Data processing in the context of newsletters or other update services is ordinarily controlled by the respective Giant Swarm entity.
If different Giant Swarm entities exceptionally act as joint controllers, Giant Swarm is designated as a single point of contact for data subjects under the GDPR.
...
In order to further optimize the user experience and in particular tailor the information provided to you, we process information on your specified preferences, if any, and in some instances, follow your consumption of material (user statistics).
All newsletter activities and other update services serve marketing purposes and business development.

#### Legal basis for the processing & legitimate interests for the processing

The processing is based on our legitimate interests according to Art. 6 (1) f GDPR to pursue our business interests of marketing and business development, or, as the case may be, for the performance of a contract according to Art. 6 (1) b GDPR.
If there is no legitimate interest or contractual necessity to process your personal data, we will ask you for your explicit consent under Art. 6 (1) a GDPR.

#### Recipients

In the conduct of our business, we share certain business development data within Giant Swarm.
We also share certain business development data with our business partners (e.g., Amazon Web Services and the Microsoft Partner Network) in accordance with accepted market practice.
...
Generally, data processing activities in the context of our career portal are controlled by Giant Swarm. Further processing activities regarding the assessment of your application are controlled by the relevant Giant Swarm entity the application is aimed at.
If different Giant Swarm entities exceptionally act as joint controllers, Giant Swarm is designated as a single point of contact for data subjects under the GDPR.

#### Description and purposes of the processing

We use third-party Career Portal Breezy HR (https://breezy.hr/ ) for initial engagement during our recruiting process. Giant Swarm uses the subdomain hosted on breezy.hr here: https://giantswarm.breezy.hr/, which allows the candidate to login through different methods built into the Breezy Portal including LinkedIn and directly through the breezy.hr portal. To understand how these third-party website handle your data, please refer to the respective privacy policies:
...
We keep our Breezy HR portal up to date with the newest positions available at Giant Swarm. As soon as we are advertising a position, you will find our current job opportunities on this page. You can browse through them without registration. Our general privacy notice for the use of our website applies (cf. 2.1.).

#### Login with online application portal

The first step to hand in an online application is to choose either to login through LinkedIn or fill out the information on the  https://giantswarm.breezy.hr/ page. At this point we only ask you for your basic contact data, e.g. name and e-mail address.

#### Completion and handing in of an application

To complete and hand in an application, we ask you to provide us with various “applicant data”, e.g.
...
We use that applicant data to

- evaluate and select candidates,
- set up and conduct interviews and tests,
- evaluate and assess the results of those interviews and test, or
- if otherwise needed in the recruitment processes.

#### Sources of data (if not obtained directly from you)

Generally, all applicant data is directly obtained from you.

#### Legal basis for the processing & legitimate interests for the processing

The processing is generally based on Art. 6 (1) b GDPR in order to take steps at the request of you as the data subject prior to entering into a contract.

#### Recipients

Internally, your personal data will only be processed by the Giant Swarm entity or office which posted the job offer and by the relevant personnel department.

Your application and any other information that you provide to us will be held on systems operated on our behalf by Breezy HR, inc. (40 24th St.2nd Floor Pittsburgh, PA 15222), and will be stored in the United States of America and Germany.

Breezy HR, inc. is under contract with Giant Swarm to ensure that your information is protected to standards required by us in accordance with applicable Data Protection Legislation and is only processed in accordance with our instructions.

For further information on how Breezy HR, inc. handles cookies, see the  Breezy HR, inc. own cookie policy: https://breezy.hr/privacy

#### Transfer of personal data to third countries or international organisations

When you apply to a position for one of the Giant Swarm entities, your application will be forwarded accordingly. We have in place standard contractual clauses according to Art. 46 (1) lit. c GDPR that cover all transfers within Giant Swarm.

#### Retention period

We retain personal data only for as long as there is a genuine business reason or other legal ground to do so.

Your basic contact data will be erased if you contact Giant Swarm and ask for your data to be deleted. If you wish to delete or correct your information from Breezy HR, inc., please visit the Account screen. If you do not have an account, please contact privacy@breezyhr.com.

Your applicant data will be stored for a period of time sufficient to enable us to review your application, and as long as necessary for general human resource management purposes.

If your application is not successful or if you withdraw your application, your application data will be erased after twelve months.

If you give us your specific consent, we store your application information in our recruitment system for a period of 24 months counting from your last visit.

If your application is successful, any data provided through this recruitment system may be further processed for performance of your employment contract, esp. for keeping your personnel files.

Applicants should note that they have the right to access, modify or erase any information concerning their personal profile in compliance with applicable Data Protection Legislation (cf. 6.).

#### Possible consequences of failure to provide data

There are no negative consequences if you do not provide us the above mentioned personal data. However, only if all necessary blanks of the application form in our career portal are filled out completely, the application can be handed in. Without providing your personal data it will not be possible to progress the application and the application will be cancelled.

## 5. Contact and Communication {#section5}

### Controller

If you use the contact options on our website, the respective data processing is controlled by Giant Swarm (cf. 2.1). Single Giant Swarm entities may be controller if you contact them directly.
...
We share the above-mentioned personal data, in particular contact data, within those Giant Swarm entities your request is aimed at.

#### Transfer of personal data to third countries or international organisations

We share the above-mentioned personal data, in particular contact data, with those Giant Swarm entities in third countries your request is aimed at. We have in place standard contractual clauses according to Art. 46 (1) lit. c GDPR that cover all transfers within Giant Swarm.
...
- thea@giantswarm.io 
- Phone: 0221- 97599790
- Via Post: c/o Startplatz, Im Mediapark 5, 50670 Köln